...
React JS is a JavaScript library created by a team at Facebook for building user interfaces. It's designed to scale and work on small projects, or massive ones such as Facebook.

- [x] What does it mean to _think_ in react?

Almost everything that seems logical to be so, should be its own component. A simple example would be a Footer component that holds all of the code required to display the footer of a site and any functionality it may have. There could be a SearchBar component inside of the Footer component.

- [x] Describe state.

State is just data inside of our React application.

- [x] Describe props.

Props is linking the data i.e. state from one component to be used by another component seperate from where the state is.
